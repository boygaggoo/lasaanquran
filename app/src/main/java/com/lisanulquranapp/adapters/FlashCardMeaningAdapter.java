...
public class FlashCardMeaningAdapter extends BaseAdapter {
    private List<CardsModel> list;
    private Context context;

    public FlashCardMeaningAdapter(List<CardsModel> modelList, Context context) {
        list = modelList;
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.flash_card_meaning_item, viewGroup, false);
        }
